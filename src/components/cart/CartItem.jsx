...
const CartItem = (props) => {
  ...
  const onAddFav = async (obj)=>{
    try{
      ...
      if(findFavorites){
        axios.delete(`https://637f91ca2f8f56e28e904e7d.mockapi.io/favprites/${findFavorites.id}`)
        props.setFavorites((over) => over.filter(o=>o.myId !== obj.myId))
      }
      else{
        const {data} =await axios.post(`https://637f91ca2f8f56e28e904e7d.mockapi.io/favprites`, obj)
